...
class QuantumHybridSolver:
    ...
    def solve_vrp_quantum(self, problem: VRPProblem, num_runs: int = 3, clustering_method: str = 'kmeans') -> Tuple[Dict[int, List[int]], float, Dict]:
...
def api_solve(nodes_data: List[Dict], vehicles_data: List[Dict]) -> str:
    ...
    with redirect_stdout(captured_output):
        ...
        vrp_routes, vrp_cost, vrp_details = solver.solve_vrp_quantum(vrp_problem, num_runs=1, clustering_method='spectral')
